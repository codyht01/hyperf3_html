    ...
    <div class="layout-padding">
        <div class="layout-padding-auto layout-padding-view">
            <div class="flex-margin" style="width: 400px">
                <el-result icon="warning" subTitle="可 `开启 TagsView 共用` 进行单标签测试" title="动态路由">
                    <template #extra>
                        <el-alert :closable="false" class="mb30" type="success">
                            <template #default>
                        ...
                        <el-input v-model="state.tagsViewName" class="mb15" clearable placeholder="请输入tagsView 名称" style="width: 400px"></el-input>
                        <el-input v-model="state.value" clearable placeholder="请输入路由参数id值" style="width: 400px"></el-input>
                        <el-button class="mt15" size="default" type="primary" @click="onGoDetailsClick">
                            <SvgIcon name="iconfont icon-dongtai"/>
                            动态路由传参
                        </el-button>
                        <el-button class="mt15" size="default" type="primary" @click="onChangeI18n">
...
<script lang="ts" name="paramsDynamic" setup>
