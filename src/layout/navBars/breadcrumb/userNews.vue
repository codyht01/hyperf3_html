<template>
    <div class="layout-navbars-breadcrumb-user-news">
        <div class="head-box">
            ...
            <div v-if="state.newsList.length > 0" class="head-box-btn" @click="onAllReadClick">{{ $t('message.user.newBtn') }}</div>
        </div>
        ...
        <div v-if="state.newsList.length > 0" class="foot-box" @click="onGoToGiteeClick">{{ $t('message.user.newGo') }}</div>
    </div>
</template>
