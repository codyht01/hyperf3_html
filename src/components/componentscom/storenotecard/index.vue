<template>
    <div class="storenotecard">
        ...
        >
          ...
          width:
            ...
            >
                ...
                >
                    <img alt="" draggable="false" src="../../../assets/images/imgs.png"/>
                    <!-- 标签 -->
                    <p v-if="datas.noteLabels" class="marks"><span>#</span>笔记标签</p>
                </div>
                ...
                >
                    ...
                    <!-- 点赞和阅读量 -->
                    <div class="dianz">
                        <span v-if="datas.readingNumber" class="fir">999 阅读</span>
                        <span v-else></span>
        ...
        <p v-show="datas.viewMore2" class="more2">
            查看更多
            <van-icon name="arrow"/>
        </p>
