<template>
  <div class="sku">
    ...
    <el-dialog v-model="dialogVisible" :title="visible_title" width="30%">
      <el-input-number v-model="visible_number"/>
      <template #footer>
...
const asyncCheckbox = () => {
  ...
  let data_list: any[] = []
  let res_data: { data_title: any; specs_id: string; price: string; stock: string; cost_price: string; image: string; market_price: string; }[] = []
